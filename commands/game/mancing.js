    ...
    execute: async (
        ...
        if (!user.rod) {
            return sock.sendMessage(from, {
                text: "❌ *BELUM PUNYA PANCINGAN!* ❌\n\nKamu harus beli pancingan dulu di *!shop pancing*.\n\nBamboo Rod cuma 500 koin kok!",
            });
        }
        ...
        if (user.rod.durability <= 0) {
            ...
            saveDB(db);
            return sock.sendMessage(from, {
                text: "💥 *KRAKK!!* Pancingan kamu patah saat melempar kail! Beli baru di *!toko-pancing*.",
            });
        }
        ...
        if (rand <= 0.0000001) {
            // MYTHICAL (The Leviathan)
            result = {
                name: "THE LEVIATHAN",
                reward: 5000,
                emoji: "🐉",
                msg: `BUMI BERGETAR!! KAMU MENANGKAP MONSTER LAUT!!`,
            };
        } else if (rand <= 0.5 + luckBonus) {
            // Legendary
            const types = [
                "Hiu Putih",
                "Paus Biru",
            ...
            result = {
                ...
                reward: price,
                emoji: "🦈",
                msg: `JACKPOT! Anggap aja gaji harian.`,
            };
        } else if (rand <= 20 + luckBonus) {
            // Rare
            ...
            result = {
                ...
                reward: price,
                emoji: "🐠",
                msg: `Lumayan, setara sebutir berlian.`,
            };
        } else if (rand <= 60) {
            // Common
            const types = [
            ...
            result = {
                ...
                reward: 0,
                emoji: "🚮",
                msg: `Zonk! Hobimu buang-buang uang ya.`,
            };
        }
